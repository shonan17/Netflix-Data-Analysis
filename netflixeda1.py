...
fig = px.histogram(df[df['type'] == "Movie"], x='duration_minutes', nbins=100, title="Distribution of Movie Durations", color_discrete_sequence=['purple'])  # Create a histogram for movie durations
st.plotly_chart(fig)  # Display the chart in the Streamlit app
